...
export class ClientPage implements OnInit {
  ...
  id: number;
  table: string="thirdparty/clients/details?clientId=";
  table1: string="thirdparty/clients/update";

  table2: string="thirdparty/contacts/addPhone";
  table3: string="thirdparty/clients/addNewContact";
  table4: string="thirdparty/contacts/activate";
  table5: string="thirdparty/contacts/disable";
  table6: string="thirdparty/clients/unable";
  table7: string="thirdparty/clients/disable";
...
async getdatacontactlist() {
 ...
 async onChangeTypenewPhone(event){
  this.phonenumbertypenew =event.target.value
 }
