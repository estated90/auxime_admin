...
@Component({
  selector: 'app-contrats-cape',
  templateUrl: './contrats-cape.page.html',
  styleUrls: ['./contrats-cape.page.scss'],
})
export class ContratsCapePage implements OnInit {
  ...
  table: string="contractManagement/commercialContract/list";
