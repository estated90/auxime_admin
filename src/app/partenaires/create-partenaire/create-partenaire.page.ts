...
@Component({
  ...
  templateUrl: './create-partenaire.page.html',
  styleUrls: ['./create-partenaire.page.scss'],
})
export class CreatePartenairePage implements OnInit {
  public editorValue: string = '';

  id: number;
  table: string="thirdparty/partners/create";
  indicatif : string = '+33';
  phone: any;
  street: any;
  number: any;
